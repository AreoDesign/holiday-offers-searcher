...
//        then
    ...
    public static RainbowOfferClientDto prepareCdto() {
        return RainbowOfferClientDto.builder()
                .requestDate(LocalDateTime.parse("Tue, 02 Jul 2019 18:25:55 GMT", DateTimeFormatter.ofPattern("EEE, dd MMM yyyy HH:mm:ss z", Locale.ENGLISH)).plusHours(2))
                .offerCode("zante-village_89776")
                .offerUrl("/zakynthos-wczasy/zante-village?data=20190924&liczbaDoroslych=2&liczbaDzieci=1&liczbaPokoi=1&wiekDzieci=0&miastoWyjazdu=warszawa&wyzywienie=all-inclusive")
                .departureDateAndTime("2019-09-24T00:00:00Z")
                .boardType("all-inclusive")
                .rating("4.60")
                .discountPerPersonPrice(1550)
                .originalPerPersonPrice(1550)
                .duration(4)
                .promotionPercentage(38)
                .hotelCode(String.valueOf(1245))
                .hotelName("Zante Village")
                .hotelStandard(3.5d)
                .destination("Grecja/Zakynthos")
                .build();
    }
